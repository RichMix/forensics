...
try:
    ...
    # Instead of using flag_length, take all remaining bytes as the encrypted flag
    encrypted_flag_data = encrypted_data[5:]
    ...
    print("Error: Encrypted data is too short to extract necessary fields.")
except UnicodeDecodeError:
